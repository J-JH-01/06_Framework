...
public class FileConfig implements WebMvcConfigurer {
	...
	// 스프링 구성을 커스타마이징하고 확장하기 위한 메서드를 제공함
	// 주로 웹 어플리케션의 설정을 조정하거나 추가하는데 사용됨

	// 파일 업로드 임계값
	@Value("${spring.servlet.multipart.file-size-threshold}")
	private long fileSizeThreshold; //52428800 들어옴
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		// Spring MVC에서 정적 리소스(이미지,css,js 파일 등)의 요청을 처리하기 위해 사용하는 클래스
