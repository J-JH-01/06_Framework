...
public class ParameterController {
	 ...
	 * 
	 *--> ArgumentResolver (전달 인자 해결사) 얘가 해줌
	 */
	...
	public String paramTest3(@RequestParam("color") String[] colorArr,
		...
		//paramMap : {color=Red, fruit=Apple, productName=아름다운조명, expirationDate=2024-10-25}
		// -> Key(name 속성값)이 중복되면 덮어쓰기가 된다!
